...
class Translator(nn.Module):
    ...
    def __init__(
        self, model, beam_size, max_seq_len, src_pad_idx, trg_pad_idx, trg_bos_idx, trg_eos_idx
    ):
        ...
        self.register_buffer(
            "blank_seqs", torch.full((beam_size, max_seq_len), trg_pad_idx, dtype=torch.long)
        )
