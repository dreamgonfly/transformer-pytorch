...
TranslationDataset.prepare(
    args.train_source, args.train_target, args.val_source, args.val_target, args.save_data_dir,
)
...
IndexedInputTargetTranslationDataset.prepare(
    args.save_data_dir, source_dictionary, target_dictionary
)
